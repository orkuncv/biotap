...
class InstallCommand extends AbstractCommand
{
    ...
    public function execute(array $options): int
    {
        ...
        $this->themeSlug = $this->globalConfig['THEME_SLUG'] ?? 'nova';
        ...
        $currentVersion = $this->getCurrentVersion($this->themeSlug, $this->globalConfig['THEMES_DIR']);
        ...
        if ( ! $this->unzipFile($zipFilePath, $this->globalConfig['THEMES_DIR'])) {
