...
class Aanbod_Websites {
    ...
    public function render_checkout_shortcode($atts) {
        ...
        $base_price = get_post_meta($website_id, '_website_base_price', true);
        $global_extras = get_option('website_global_extras', []);
                ...
                <div class="checkout-right">
                    ...
                    <div class="order-summary">
                        ...
                        <div class="summary-row">
                            <span><?php _e('Basisprijs', 'aanbod-websites'); ?></span>
                            <span class="price" id="base-price" data-price="<?php echo esc_attr($base_price); ?>">
    ...
    public function handle_order_submission() {
        ...
        // Get website data
        $website = get_post($website_id);
        $base_price = (float) get_post_meta($website_id, '_website_base_price', true);
        $global_extras = get_option('website_global_extras', []);
        $custom_extras = get_post_meta($website_id, '_website_extras', true);

        // Calculate total and get selected extras
        ...
        if ($order_id) {
            ...
            $this->send_order_notification($order_id, $website, $sanitized_form_data, $selected_extras, $total_price);
    ...
    private function send_order_notification($order_id, $website, $form_data, $selected_extras, $total_price) {
